...
curl "http://www.wcc.nrcs.usda.gov/nwcc/view?intervalType=$INTERVALTYPE+&report=$REPORT&timeseries=$SERIES&format=copy&sitenum=$STATION&interval=$INTERVAL" -o data/real-time_processing/snoteldownloads/$STATION-$INTERVAL.csv
