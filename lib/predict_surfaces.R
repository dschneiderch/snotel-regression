...
predict_surfaces=function(rdatedF,snotellocs,snotellocs.usgs,newdata,newdatalocs,newdatalocs.agg.usgs,spatialblend,bpth,scalesnotel,fordensource,dateflag,predictor){
          ...
          if(length(static_mdl)>1){
               ...
               if(length(dyn_mdl)>1){
                    ...
                    newdatapreds=data.frame(
                         ...
                         reconrt.predictions=reconrt.pred)
                    ...
                    if(spatialblend=='blend'){
                         ...
                         newdatapreds$phv.predictions[newdatapreds$phv.predictions<0]=0.001#individual masking because newdatapreds needs x y
                         newdatapreds$phvrcn.predictions[newdatapreds$phvrcn.predictions<0]=0.001
                         newdatapreds$reconrt.predictions[newdatapreds$reconrt.predictions<0]=0.001
