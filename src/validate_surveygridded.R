...
if(yr<=2003){
    ...
    mdlswe=rbind(phvswe,phvrcnswe,reconswe,snodasswe)
...
for(dateflag in c('B2')){
for(residblend in c('')){
# scalesnotel='noscale'
for(scalesnotel in c('noscale')){
# fscaMatch='wofsca'
...
if(residblend=='full') saveRDS(swe,file=paste0('data/spatialvalidation/blended/',dateflag,'/',style,'/surveygriddedswe',gridding,'_rswe',recon.version,'_',covrange,'_snotel',scalesnotel,postscaled,'_',cost,'_',fscaMatch,'.rds'))
if(residblend=='') saveRDS(swe,file=paste0('data/spatialvalidation/unblended/',dateflag,'/',style,'/surveygriddedswe',gridding,'_rswe',recon.version,'_',covrange,'_snotel',scalesnotel,postscaled,'_',cost,'_',fscaMatch,'.rds'))
